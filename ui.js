...
const ModalManager = (() => {
    ...
    const handleApiError = async (error, options = {}) => {
        const {showDetails = true, defaultTitle = 'Lỗi', defaultMessage = 'Đã có lỗi xảy ra'} = options;
        ...
        return alert({icon: 'error', title: titleText, html, confirmButtonText: 'Đóng'});
        //                              ^^^^^
    };
    ...
    return {
        ...
        isOpen,
        getStack,
        swal: {alert, confirm, toast, handleApiError},
    };
})();

if (typeof module !== 'undefined' && module.exports) module.exports = ModalManager;
